...
public class TesseractDriver
{
    ...
    public string CheckTessVersion(string langCode)
    {
    ...
    public void OcrSetup(UnityAction onSetupComplete)
    {
        ...
        if (_tesseract.Init(langCode, datapath))
        {
    ...
    private async void CopyAllFilesToPersistentData(List<string> fileNames, UnityAction onSetupComplete)
    {
        ...
        foreach (String fileName in fileNames)
        {
            if (!File.Exists(toPath + fileName))
            {
                ...
                UnityWebRequest unityWebRequest = new UnityWebRequest(fromPath + fileName);
                ...
                File.WriteAllBytes(toPath + fileName, unityWebRequest.downloadHandler.data);
